...
class EnrollmentsControllerTest < ActionController::TestCase
  ...
  test "should create enrollment" do
    assert_difference('Enrollment.count') do
      post :create, enrollment: { course_id: @enrollment.course_id, courserole: @enrollment.courserole, user_id: @enrollment.user_id }
    end
  ...
  test "should update enrollment" do
    patch :update, id: @enrollment, enrollment: { course_id: @enrollment.course_id, courserole: @enrollment.courserole, user_id: @enrollment.user_id }
    assert_redirected_to enrollment_path(assigns(:enrollment))
  end
